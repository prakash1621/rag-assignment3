...
> 📐 Full diagram available as a draw.io file: [`architecture.drawio`](architecture.drawio) — open in [draw.io](https://app.diagrams.net/) or VS Code with the Draw.io Integration extension.
